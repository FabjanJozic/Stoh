...
ax.plot(isim, vor32_150, color='orange', lw=0.2, linestyle='--', zorder=2)
ax.plot(isim, avor32_150, color='cyan', lw=0.2, linestyle='--', zorder=3)
ax.scatter(isim, vor32_50, color='red', s=40, marker='d', label='vortex, $Nb^{+} = 50$', zorder=4)
ax.scatter(isim, avor32_50, color='blue', s=20, marker='s', label='antivortex, $Nb^{+} = 50$', zorder=5)
ax.scatter(isim, vor32_150, color='orange', s=40, marker='d', label='vortex, $Nb^{+} = 150$', zorder=6)
ax.scatter(isim, avor32_150, color='cyan', s=20, marker='s', label='antivortex, $Nb^{+} = 150$', zorder=7)
ax.set_xlim(0, 101)
ax.set_ylim(0, 1500)
...
# usporedba sustava 32*32 i 64*64 spina
fig = plt.figure(figsize=(12,6), dpi=110)
ax = fig.add_axes([0.10, 0.15, 0.85, 0.75])
plt.rcParams.update({'font.size': 12}) #type: ignore
ax.plot(isim, vor32_50, color='red', lw=0.2, linestyle='--', zorder=0)
